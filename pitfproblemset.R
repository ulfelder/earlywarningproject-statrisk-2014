...
reg <- readWorksheetFromFile("pitf adverse regime changes 2013.xls",
...
eth <- readWorksheetFromFile("pitf ethnic wars 2013.xls",
  sheet=1, startCol=1, endCol=13)
...
rev <- readWorksheetFromFile("pitf revolutionary wars 2013.xls",
  sheet=1, startCol=1, endCol=13)
...
gen <- readWorksheetFromFile("pitf genopoliticides 2013.xls",
...
write.csv(pitf, "pitfproblemset.csv", row.names = FALSE)
